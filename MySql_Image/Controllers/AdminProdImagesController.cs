...
{
    public class AdminProdImagesController : Controller
    {
        private readonly ProductImageDbContext _context;

        public AdminProdImagesController(ProductImageDbContext context)
        {
            _context = context;
        }
        ...
        // GET: AdminProdImages/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: AdminProdImages/Create
